<template>
  <div class="content">
    ...
    <ul>
      ...
      <li class='lisecond'>
        <input type="text" value="" v-model="nikename"/>
        <span>昵称</span>
      </li>
      <li>
...
.content h1{width:2.18rem;height:2.1rem; background:url(../assets/img/my_cz.png) no-repeat 0 0; background-size:100%; margin:0 auto; }
...
.content ul{width:5.78rem;height:2.92rem; border:1px solid #e5e7e8; background:#fff; margin:0 auto; margin-top:0.18rem;}
.content ul li{height:0.95rem; position:relative;}
.content ul li.lifirst{border-bottom:1px solid #e5e7e8;}
.content ul li.lisecond{border-bottom:1px solid #e5e7e8;}
...
.content .footbox{width:4.65rem;height:0.65rem;margin:0.3rem auto; }
