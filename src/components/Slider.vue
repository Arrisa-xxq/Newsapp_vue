<template>
      <div class="banner">
    <ul class="clearfix">
      <router-link tag='li' :to="`/detail/${item._id}?dataName=banner`" v-for="item of banner"
      :key="item._id"
      >
...
.banner ul li img{width:100%; display:block;margin-top:0.6rem}
